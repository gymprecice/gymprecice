...
# TODO:
# switch to https://github.com/niasw/openfoamparser
# reduce the amout of our code significatly
...
from gymprecice.envs.openfoam.field_parser import parse_internal_field, is_binary_format
...
class FoamMesh(object):
    ...
    def boundary_face_area(self, bd):
        """
