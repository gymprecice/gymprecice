...
def patch_env_helpers(mocker):
    mocker.patch(
        "gymprecice.envs.openfoam.rotating_cylinder_2d.environment.get_interface_patches",
        return_value=[],
    )
    mocker.patch(
        "gymprecice.envs.openfoam.rotating_cylinder_2d.environment.get_patch_geometry",
        return_value={},
    )
